...
const FALLBACK_NEWS_DATA: NewsItem[] = [
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1534447677768-be436bb09401?q=80&w=1494",
    category: "USA",
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1517021897933-0e0319cfbc28?q=80&w=1439",
    category: "World",
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1558877385-81a1c7e67d72?q=80&w=1470",
    category: "Business",
    timestamp: "2 hrs ago",
    ...
    const fetchNews = async () => {
      ...
      try {
        ...
        if (mappedData.length < 8) {
          ...
          const fallbackFill = FALLBACK_NEWS_DATA.slice(0, needed).map(
            (item, index) => ({
              ...item,
